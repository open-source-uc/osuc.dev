...
const leadersAndYear: { year: string, leaders: LeaderProps[] }[] = [
    ...
    },
    {
        ...
        leaders: [
            ...
            {
                name: 'Xavier Morales', description: 'Educación y Vinculación con el Medio',
                githubUser: null
            },
            { name: 'Amelia Fernández', description: 'Educación y Vinculación con el Medio', githubUser: null }
        ]
    },
    {
        year: '2023-2',
    ...
    },
    {
        ...
        leaders: [
            ...
            {
                name: 'Benjamín Vicente', description: 'Proyectos', githubUser: 'benjavicente'
            },
            {
                name: 'Fernando Smith', description: 'Educación', githubUser: 'FernandoSmith'
            },
            {
                name: 'Lucas Natero', description: 'Externo y Diseño', githubUser: 'lnatero'
            },
            { name: 'Diego Costa', description: 'Comunidad', githubUser: "diegocostares" },
            {
                name: 'Agustín Covarrubias', description: 'Comodín',
                githubUser: "agucova"
            }
        ]
    },
    {
        ...
        leaders: [
            ...
            {
                name: 'Caua Paz', description: 'Técnico, asiste en forma online (Ret)', githubUser: null
            },
            {
            ...
            { name: 'Alister Mac Cormack', description: 'Administrativo, Técnico, Social', githubUser: null }
        ]
    },
    {
        year: '2021-2',
