...
<header class="bg-base-950 text-base-100">
	<div class="container px-4 py-4 flex justify-between">
		<div>
			<a href="/" class="flex items-center justify-center gap-3 font-display font-semibold text-xl">
				<svg viewBox="0 0 40 56" class="h-8 -mt-1" xmlns="http://www.w3.org/2000/svg">
					<path
						fill="currentColor"
						fill-rule="evenodd"
						clip-rule="evenodd"
...
<footer class="bg-base-950 text-base-500 text-center px-2 py-4">
	&copy; Open Source UC {new Date().getFullYear()} - Página en desarrollo
</footer>
